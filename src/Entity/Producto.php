...
class Producto
{
     ...
     */
    public function getVenta(): Collection
    {
        return $this->venta;
    }

    public function addVentum(Venta $ventum): self
    {
        if (!$this->venta->contains($ventum)) {
            $this->venta[] = $ventum;
        }
    ...
    public function removeVentum(Venta $ventum): self
    {
